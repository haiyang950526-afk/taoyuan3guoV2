...
MAPS["ch09_guiyang"] = {
  ...
  transitions: [
    ...
    // 店铺室内下钻（朝门才进，路过不触发）
    { x: 4,  y: 5,  face: [0, -1], to: { map: "ch09_inn_in", x: 4, y: 4 } },
    { x: 12, y: 5,  face: [0, -1], to: { map: "ch09_weapon_in", x: 4, y: 4 } },
    { x: 13, y: 5,  face: [0, -1], to: { map: "ch09_armor_in", x: 4, y: 4 } },
    { x: 4,  y: 11, face: [0, -1], to: { map: "ch09_item_in", x: 4, y: 4 } },
  ],
};
