...
MAPS["ch02s_village"] = {
  ...
  transitions: [
    ...
    { x: 3, y: 5, face: [0, -1], to: { map: "ch02s_village_inn_in", x: 4, y: 4 } },
    { x: 12, y: 5, face: [0, -1], to: { map: "ch02s_village_item_in", x: 4, y: 4 } },
    // 民房下钻（朝门才进，路过不触发）
    { x: 3, y: 11, face: [0, -1], to: { map: "ch02s_village_house_in", x: 5, y: 6 } },
  ],
};
